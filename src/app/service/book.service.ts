...
export class BookService {
  ...
  private bestPromoOf(offers: Offer[], price: number): Offer {
    ...
    console.info(prices);
    let ret = offers[prices.indexOf(Math.min.apply(Math, prices))];
